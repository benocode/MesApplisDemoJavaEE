...
<body>
	...
	<header class="container">
		<hr>
		<div class="row">
			<h1 class="mx-auto my-5">Accueil</h1>
		</div>
	</header>
	
	<main class="container">
		<div class="my-10 d-flex justify-content-around">
			<form method="get" action="<%=request.getContextPath() %>/applications/SuiviDesRepas/AjoutRepas">
				<button type="submit" class="btn btn-secondary">
					Ajouter un nouveau repas
				</button>
			</form>
			<form method="get" action="<%=request.getContextPath() %>/applications/SuiviDesRepas/VisualisationRepas">
				<button type="submit" class="btn btn-secondary">
					Visualiser les repas
				</button>
			</form>
		</div>
	</main>
