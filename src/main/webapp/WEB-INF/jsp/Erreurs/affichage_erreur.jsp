...
<body>
	...
	<main class="container">
		<p>Malheureusement une erreur s'est produite, nous la traitons dans les plus brefs délais</p>
		<hr>
		<p class="my-2">
			<strong>Type d'erreur :</strong> <%=exception%><br>
			<strong>Message d'erreur :</strong> <%=exception.getMessage()%>
		</p>
		<hr>
		<div class="my-10 d-flex justify-content-around">
			<a href="<%=request.getContextPath() %>/index.html"><button type="submit">
				Retour au menu
			</button></a>
		</div>
	</main>
